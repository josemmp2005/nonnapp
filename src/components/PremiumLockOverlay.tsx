...
const PremiumLockOverlay: React.FC = () => {
  ...
  return (
    <div className="absolute inset-0 z-10 flex items-center justify-center bg-white/80 dark:bg-surface-dark/85 backdrop-blur-[2px] rounded-2xl">
      <div className="text-center px-4">
        ...
        <p className="text-sm font-bold text-ink dark:text-[#F8F2E6] flex items-center gap-1.5 justify-center">
          <Crown className="w-4 h-4 text-amber-500" />
          {t('app.preferences.lockOverlay')}
        </p>
      </div>
    </div>
  );
