...
// Fade + translateY al entrar en viewport. Sustituye a un "animate-in" fijo
// en el mount (que no distingue si la sección ya estaba visible al cargar o
// si se llega a ella haciendo scroll) por algo que reacciona de verdad al
// scroll, sin librería de animación. Siempre renderiza un <div> — como
// elemento de flex/grid se comporta igual que un <span> para el layout,
// así que no hace falta soportar una etiqueta variable (y su lío de tipos
// de `ref`) solo por eso.
