...
const ResetPasswordPage: React.FC = () => {
  ...
  if (!token) {
    return (
      <div className="min-h-[80vh] flex items-center justify-center px-4 py-10">
        <div className="bg-white dark:bg-surface-dark rounded-2xl shadow-xl p-8 w-full max-w-md border border-ink/10 dark:border-ink-light/10 text-center animate-in fade-in zoom-in-95 duration-300">
          <XCircle aria-hidden="true" className="w-12 h-12 mx-auto text-red-500 mb-4" />
          <h2 className="text-xl font-bold text-ink dark:text-[#F8F2E6] mb-2">{t('app.resetPassword.invalidLinkTitle')}</h2>
          <p className="text-muted dark:text-muted-dark mb-6 text-sm">{t('app.resetPassword.invalidLinkText')}</p>
          <button
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-10">
      <div className="bg-white dark:bg-surface-dark rounded-2xl shadow-xl p-8 w-full max-w-md border border-ink/10 dark:border-ink-light/10 transition duration-300 hover:shadow-2xl hover:shadow-primary/5">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-muted dark:text-muted-dark mt-2 text-sm text-center">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1">
            <label htmlFor="reset-password" className="text-sm font-medium text-body dark:text-body-dark">
          ...
          <div className="space-y-1">
            <label htmlFor="reset-confirm-password" className="text-sm font-medium text-body dark:text-body-dark">
        ...
        <div className="mt-6 text-center">
          <button
            onClick={() => navigate('/auth')}
            className="text-sm text-muted dark:text-muted-dark hover:text-primary"
          >
            {t('app.auth.backToLogin')}
          </button>
        </div>
